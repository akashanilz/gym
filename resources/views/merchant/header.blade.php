...
<head>
    ...
    <link rel="stylesheet" href="{{asset('adminsidenav1.css')}}">
    <link rel="stylesheet" href="{{asset('style/admin/dash1.css')}}">
...
<body>
    <nav id="navbar1"  class="navbar sticky-top navbar-expand-lg navbar-light bg-success">
        <img src="" width="25px";>
        ...
        <div  class="collapse navbar-collapse" class="text" id="navbarNavDropdown">
          <ul class="navbar-nav">
           ...
           <li class="nav-item active">
            <a id="text" class="nav-link" href="{{ route('user.merdash') }}">Home <span class="sr-only"></span></a>
          </li>
