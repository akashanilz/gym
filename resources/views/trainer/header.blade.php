...
<head>
    ...
    <link rel="stylesheet" href="{{asset('adminsidenav2.css')}}">
    <link rel="stylesheet" href="{{asset('style/admin/dash2.css')}}">
...
<body>
    <nav id="navbar1"  class="navbar sticky-top navbar-expand-lg navbar-light bg-warning">
        <img src="" width="25px";>
        ...
        <div  class="collapse navbar-collapse" class="text" id="navbarNavDropdown">
          <ul class="navbar-nav">
           ...
           <li class="nav-item active">
            <a id="text" class="nav-link" href="{{ route('user.traindash') }}">Trainer Dashboard<span class="sr-only"></span></a>
          </li>
